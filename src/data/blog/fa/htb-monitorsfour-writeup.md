...
### درباره اتصال به ماشین های HackTheBox 

خب... برای اونایی که هنوز توی HackTheBox شرکت نکردن تا حالا یا تازه شروع کردن و براشون سواله... اتصال به ماشین ها دو راه داره. یا می تونید از اتصال گرافیکی به یه ماشین Attack که در واقع یه نسخه آماده شده ParrotOS هست استفاده کنید یا اتصال مستقیم به شبکه ماشین هدف با OpenV.P.N.

معقولانه تره که ما با OpenV.P.N وصل بشیم و توی محیط خودمون با راحتی بیشتر با IP هدف تعامل برقرار کنیم. از طرفی هم Attack Machine خود این پلتفرم برای پلن رایگان محدودیت زمانی داره و برای دسترسی نامحدود باید اشتراک تهیه کنید.

حالا مشکل کجاست؟ مشکل اینجاست که آقای ف.یلترچی کانشکن های openVPN رو دراپ می کنه. راه حل خاصی براش نداشتم که بشینم و یه پست دیگه راجبش بنویسم پس همینجا خلاصه جمعش میکنم.

روی ISP های مختلف امتحان کنید. بعضی ها محدودیت کمتری دارن. و همچنین تموم سرور هارو تست کنید و از UDP استفاده کنید.

برای من روی اینترنت سامانتل + سرور های سنگاپور جواب بود.

نحوه خود اتصال روی پلتفرم توضیح داده شده و کاری نداره.
...
تو کامنت های زیر بهم بگید و همچنین پیشنهاد ها و راه حل های خودتون رو هم با من درمیون بزارید. 
